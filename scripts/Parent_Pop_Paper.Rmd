...
#### Does budding duration differ by elevation/latitude/pops at WL2?
...
ggplot(WL2_24_bud_dur, aes(x=bud.duration))+
  geom_boxplot()+
  facet_wrap(~pop)
...
Anova(WL2_bud_dur_elev) #Elevation is significant but latitude is not

...
WL2_bud_dur_FrFlN <- lmer(FrFlN ~ bud.duration + (1|pop),
...
ggplot(WL2_dt_bud_FrFl, aes(x=bud.date_dt, y=FrFlN, color=pop)) +
  geom_point()

WL2_bud_dt_FrFlN <- lmer(FrFlN ~ bud.date_dt + (1|pop),

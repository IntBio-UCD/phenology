...
```{r}
ggplot(WL2_24, aes(x=bud.date, fill=unique.ID)) +
  geom_histogram()

ggplot(WL2_24, aes(x=flower.date, fill=unique.ID)) +
  geom_histogram()

ggplot(WL2_24, aes(x=fruit.date, fill=unique.ID)) +
  geom_histogram()

ggplot(WL2_24, aes(x=last.FL.date, fill=unique.ID)) +
  geom_histogram()

ggplot(WL2_24, aes(x=last.FR.date, fill=unique.ID)) +
  geom_histogram()
```
